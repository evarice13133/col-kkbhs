    ...
    <div class="d-flex justify-content-center mb-5">
        <div class="filter-island px-3 py-2 shadow-lg animate-slide-down" style="min-width: 40%;">
            <div class="d-flex align-items-center justify-content-center gap-2 w-100">
                <a href="/teaching_types/create" class="btn btn-success rounded-pill px-4 fw-bold shadow-sm scale-on-hover">
                    <i class="bi bi-plus-circle me-2"></i> <?= __('add_teaching_type') ?? 'Ajouter' ?>
                </a>
            </div>
        </div>
    </div>

    <!-- LISTE DES TYPES D'ENSEIGNEMENT (Grille harmonisée) -->
    <div class="row g-2 g-md-4">
        <?php foreach ($teachingTypes as $num => $type): ?>
            <div class="col-6 col-sm-6 col-xl-3">
                <div class="subject-card-compact border-theme-dynamic h-100 position-relative <?= $type['actif'] ? '' : 'opacity-50' ?>">
