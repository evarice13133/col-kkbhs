<?php
$title = __('add_teaching_type') ?? 'Ajouter un Type Enseignement';
ob_start();
?>
...
<div class="animate-fade-in container-fluid py-2">
    ...
    <form action="/teaching_types/store" method="POST" id="teachingTypeCreateForm">
        ...
        <div class="subject-card-compact border-0 shadow-sm overflow-hidden mb-4">
            <div class="card-body p-4">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-6">
                        <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Nom (ex: Primaire)</label>
                        <input type="text" name="nom" class="form-control premium-input" 
                            placeholder="Nom du type" required autofocus>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Code (ex: PRI)</label>
                        <input type="text" name="code" class="form-control premium-input" 
                            placeholder="Code court" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Position (Ordre d'affichage)</label>
                        <input type="number" name="position" class="form-control premium-input" value="0">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Actif</label>
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" name="actif" id="actifSwitch" value="1" checked>
