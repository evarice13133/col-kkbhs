<?php $title = __('add_department'); ob_start(); ?>
            ...
            <div class="modern-card border-0 shadow-lg overflow-hidden rounded-4">
                <div class="card-header bg-primary bg-opacity-10 border-0 p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="fw-black m-0 text-primary text-uppercase letter-spacing-1"><?= __('add_department') ?></h5>
                            <p class="text-muted small mb-0"><?= __('department_details') ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="/departments/store" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted extra-small mt-1 d-block opacity-75">
                                <i class="bi bi-info-circle me-1"></i> Identifiant court utilisé pour les filtres et les imports.
                            </small>
                        </div>
