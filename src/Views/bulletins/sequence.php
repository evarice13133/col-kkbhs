                ...
                <?php foreach ($groupsChunk as $group): ?>
                    ...
                    <table class="group-subtotal-line" style="width: 100%; border-collapse: collapse; border: none; margin: 1px 0 3px; background-color: #d9e7f6; color: #17324d; font-weight: bold; font-size: 8.5px; white-space: nowrap;">
                        <tr>
                            ...
                            <td style="text-align: center; padding: 2px 7px; border: none; font-weight: bold;">T.<?= htmlspecialchars($evalSummaryLabel) ?>: <?= $groupHasEvaluationTotal ? formatSimple($groupEvaluationTotal) : '-' ?></td>
                            <td style="text-align: center; padding: 2px 7px; border: none; font-weight: bold;">T.Coef: <?= (float) ($group['total_coeffs_all'] ?? 0) ?></td>
                            <td style="text-align: center; padding: 2px 7px; border: none; font-weight: bold;"><?= strtoupper(__('total')) ?>: <?= formatSimple($groupPoints) ?></td>
                            <td style="text-align: right; padding: 2px 7px; border: none; font-weight: bold; width: 20%;">MGP: <span class="<?= $mgp >= 10 ? 'vert' : 'rouge' ?>" style="font-weight: bold;"><?= formatSimple($mgp) ?></span></td>
                        </tr>
                    </table>
                <?php endforeach; ?>
            <?php endforeach; ?>
