...
<div class="animate-fade-in container-fluid py-4">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="fw-black text-main-theme mb-0 fs-4"><?= __('add_user') ?></h2>
            <p class="text-muted-theme small mb-0"><?= __('user_creation_subtitle') ?></p>
        </div>
            ...
            <div class="modern-card border-0 shadow-sm p-4 h-100 bg-primary bg-opacity-5 border border-primary border-opacity-10">
                ...
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex align-items-start gap-3 bg-white bg-opacity-50 p-3 rounded-4 shadow-sm">
                        ...
                        <div>
                            <p class="small text-muted-theme mb-0 lh-sm"><?= __('user_creation_tip_1') ?></p>
                        </div>
                    </div>
                    <div class="d-flex align-items-start gap-3 bg-white bg-opacity-50 p-3 rounded-4 shadow-sm">
                        ...
                        <div>
                            <p class="small text-muted-theme mb-0 lh-sm"><?= __('user_creation_tip_2') ?></p>
                        </div>
                    </div>
                </div>
            </div>
