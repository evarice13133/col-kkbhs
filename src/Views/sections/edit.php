<?php $title = __('edit_section'); ob_start(); ?>

<div class="animate-fade-in container-fluid py-2">
    <!-- Compact Header -->
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h2 class="fw-black text-main-theme mb-0 fs-4"><?= __('edit_section') ?></h2>
    ...
    <form action="/sections/update" method="POST" id="sectionEditForm">
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-12 border-bottom border-theme-light pb-2 mb-2">
                        <h6 class="fw-black text-primary m-0 text-uppercase letter-spacing-1"><?= __('section_modification') ?></h6>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="nom" class="form-control premium-input" 
                            value="<?= htmlspecialchars((string) $section['nom']) ?>" required autofocus>
                        <div class="form-text extra-small mt-1 opacity-75"><?= __('edit_section_subtitle', ['name' => $section['nom']]) ?></div>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1"><?= __('honor_roll_threshold_label') ?></label>
                        <input type="number" name="honor_roll_threshold" step="0.01" min="0" max="20" class="form-control premium-input" value="<?= htmlspecialchars((string) ($section['honor_roll_threshold'] ?? '')) ?>">
