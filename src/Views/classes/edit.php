                    ...
                    <div class="col-md-6">
                        ...
                        <select name="teaching_type_id" class="form-select premium-input border-primary border-opacity-25" required>
                            ...
                            <?php foreach ($teachingTypes as $tt): ?>
                                <option value="<?= $tt['id'] ?>" <?= (($classe['teaching_type_id'] ?? null) == $tt['id']) ? 'selected' : '' ?>><?= h($tt['nom']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="department_id" id="department_id" class="form-select premium-input">
                            ...
                            <?php foreach ($departments as $dept): ?>
                                <option value="<?= $dept['id'] ?>" data-teaching-type-id="<?= $dept['teaching_type_id'] ?>" <?= (($classe['department_id'] ?? null) == $dept['id']) ? 'selected' : '' ?>>
                                    <?= h($dept['nom']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
