...
<div class="animate-fade-in container-fluid py-4">
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        <div class="d-flex align-items-center gap-3">
            <a href="/classes" class="btn btn-outline-secondary rounded-circle shadow-sm p-2 d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                <i class="bi bi-arrow-left fs-5"></i>
            </a>
            <div>
                <h2 class="fw-bold mb-0 text-body text-main-theme"><?= __('import_classes') ?></h2>
                <p class="text-secondary text-main-theme small mb-0"><?= __('import_classes_desc') ?></p>
            </div>
        </div>
        <div></div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="modern-card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                ...
                <div class="card-body p-4 pt-2">
                    <p class="small text-secondary text-main-theme mb-3"><?= __('import_classes_step1_desc') ?></p>
                    <a href="/classes/download_template" class="btn btn-outline-primary rounded-3 px-4 fw-bold">
            ...
            <div class="modern-card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4 pt-2">
                    <form action="/classes/upload" method="POST" enctype="multipart/form-data">
