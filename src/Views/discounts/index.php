...
<div class="animate-fade-in container-fluid py-3 px-md-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="fw-black text-main-theme mb-0 fs-4">Gestion des Réductions</h2>
            <p class="text-muted-theme small mb-0">Paramétrage des remises individuelles et collectives sur la scolarité</p>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4 animate-fade-in">
        <div class="col-6 col-md-3">
            <div class="modern-card kpi-card border-0 shadow-sm">
                ...
                <div class="kpi-label">Réductions Indiv. Actives</div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="modern-card kpi-card border-0 shadow-sm">
                ...
                <div class="kpi-label">Réductions Coll. Actives</div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="modern-card kpi-card border-0 shadow-sm">
                ...
                <div class="kpi-label">Déductions Indiv. (Fixes)</div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="modern-card kpi-card border-0 shadow-sm">
                ...
                <div class="kpi-label">Déductions Coll. (Fixes)</div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        <div class="d-flex align-items-center flex-wrap gap-3">
            <ul class="nav nav-pills nav-pills-custom" id="discountTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active rounded-pill px-4 py-2 fw-bold" id="individual-tab" data-bs-toggle="tab" data-bs-target="#individual" type="button" role="tab" aria-controls="individual" aria-selected="true">
                        <i class="bi bi-person me-1"></i> Réductions Individuelles
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-pill px-4 py-2 fw-bold ms-md-2" id="collective-tab" data-bs-toggle="tab" data-bs-target="#collective" type="button" role="tab" aria-controls="collective" aria-selected="false">
                        <i class="bi bi-people me-1"></i> Réductions Collectives
                    </button>
                </li>
            </ul>
            ...
            <div class="input-group search-pill bg-white bg-opacity-10 rounded-pill px-2 border-theme-light" style="max-width: 250px; border: 1px solid var(--border-color);">
                ...
                <input type="text" id="discount-search-input" class="form-control border-0 bg-transparent shadow-none py-1.5 small text-main" placeholder="Recherche rapide..." style="font-size: 0.85rem;">
            </div>
        </div>
        ...
        <div class="tab-actions">
            ...
            <button type="button" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm" id="btn-add-indiv" data-bs-toggle="modal" data-bs-target="#addIndividualDiscountModal">
                <i class="bi bi-plus-circle-fill me-2"></i> Accorder une réduction
            </button>
            ...
            <button type="button" class="btn btn-primary rounded-pill px-4 fw-bold shadow-sm d-none" id="btn-add-coll" data-bs-toggle="modal" data-bs-target="#addCollectiveDiscountModal">
                <i class="bi bi-plus-circle-fill me-2"></i> Réduction Collective
            </button>
        </div>
    </div>
                            ...
                            <?php if (empty($studentDiscounts)): ?>
                                <tr>
                                    <td colspan="8" class="text-center py-5 text-muted">
                                        ...
                                        Aucune réduction individuelle enregistrée.
                                    </td>
                                </tr>
                            <?php else: ?>
                                    ...
                                    <tr class="student-row">
                                        ...
                                        <td class="text-center">
                                            <?php if ($sd['status'] === 'active'): ?>
                                                <span class="badge-premium badge-premium-success"><i class="bi bi-check-circle-fill"></i> Active</span>
                                            <?php else: ?>
                                                <span class="badge-premium badge-premium-secondary"><i class="bi bi-x-circle-fill"></i> Inactive</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="pe-4 text-center">
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="/discounts/toggle?id=<?= $sd['id'] ?>&scope=student" class="btn btn-sm btn-action-modern btn-confirm-toggle <?= $sd['status'] === 'active' ? 'text-warning' : 'text-success' ?>" data-confirm="Voulez-vous modifier le statut de cette réduction ?" title="<?= $sd['status'] === 'active' ? 'Désactiver' : 'Activer' ?>">
                                                    <i class="bi bi-power fs-5"></i>
                                                </a>
                                                <a href="/discounts/delete?id=<?= $sd['id'] ?>&scope=student" class="btn btn-sm btn-action-modern btn-confirm-delete text-danger" data-confirm="Voulez-vous vraiment supprimer cette réduction ? Le solde de l'élève sera recalculé." title="Supprimer">
            ...
            <div class="modern-card border-0 shadow-sm overflow-hidden">
                <div class="table-responsive">
                    <table class="table-modern">
                        <thead>
                            <tr>
                                <th class="ps-4">Classe ciblée</th>
                                <th class="text-end">Valeur de la Remise</th>
                                <th>Motif</th>
                                <th>Date d'effet</th>
                                <th class="text-center">Statut</th>
                                <th class="pe-4 text-center">Actions</th>
                            ...
                            <?php if (empty($classDiscounts)): ?>
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">
                                        <i class="bi bi-info-circle fs-4 d-block mb-2 text-secondary"></i>
                                        Aucune réduction collective de classe enregistrée.
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($classDiscounts as $cd): ?>
                                    <tr class="student-row">
                                        ...
                                        <td class="pe-4 text-center">
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="/discounts/toggle?id=<?= $cd['id'] ?>&scope=class" class="btn btn-sm btn-action-modern btn-confirm-toggle <?= $cd['status'] === 'active' ? 'text-warning' : 'text-success' ?>" data-confirm="Voulez-vous modifier le statut de cette réduction collective ?" title="<?= $cd['status'] === 'active' ? 'Désactiver' : 'Activer' ?>">
                                                    <i class="bi bi-power fs-5"></i>
                                                </a>
                                                <a href="/discounts/delete?id=<?= $cd['id'] ?>&scope=class" class="btn btn-sm btn-action-modern btn-confirm-delete text-danger" data-confirm="Voulez-vous vraiment supprimer cette réduction collective ? Les soldes de tous les élèves de la classe seront recalculés." title="Supprimer">
                                                    <i class="bi bi-trash-fill fs-5"></i>
                                                </a>
                                            </div>
                                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow-lg">
            <div class="modal-header border-bottom-0 pb-0 px-4 pt-4">
                <h5 class="modal-title fw-black text-main-theme" id="addIndivModalLabel">Nouvelle Réduction Individuelle</h5>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <div class="mb-2">
                                <input type="text" class="form-control premium-input modal-student-filter" placeholder="🔍 Tapez le nom, prénom ou matricule pour filtrer...">
                            </div>
                            <select name="student_id" class="form-select premium-input" required>
                                <option value="" disabled selected>Rechercher un élève...</option>
                        ...
                        <div class="col-md-6">
                            <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Montant / Valeur *</label>
                        ...
                        <div class="col-12">
                            <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Motif de la réduction (Type) *</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Date d'effet *</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select premium-input" required>
                                <option value="active">Active immédiatement</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                        <div class="col-12">
                            <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Commentaire</label>
                            <textarea name="commentaire" class="form-control premium-input" rows="2" placeholder="Informations additionnelles..."></textarea>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="addCollectiveDiscountModal" tabindex="-1" aria-labelledby="addCollModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow-lg">
            <div class="modal-header border-bottom-0 pb-0 px-4 pt-4">
                <h5 class="modal-title fw-black text-main-theme" id="addCollModalLabel">Nouvelle Réduction Collective (Classe)</h5>
                <button type="button" class="btn-close" data-bs-shadow="none" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="/discounts/store" method="POST">
                <input type="hidden" name="csrf_token" value="<?= \App\Core\Session::generateCsrfToken() ?>">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-12 bg-light bg-opacity-50 p-3 rounded-4 border-theme-light" style="background-color: var(--bg-body); border: 1px solid var(--border-color);">
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1" style="font-size: 0.68rem; color: var(--text-muted); opacity: 0.85;">Enseignement</label>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1" style="font-size: 0.68rem; color: var(--text-muted); opacity: 0.85;">Section</label>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1" style="font-size: 0.68rem; color: var(--text-muted); opacity: 0.85;">Cycle</label>
                        ...
                        <div class="col-12">
                            <label class="form-label text-muted-theme fw-bold extra-small text-uppercase mb-1">Sélectionner la Classe *</label>
