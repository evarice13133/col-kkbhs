    ...
    <div class="receipt-container">
        ...
        foreach ($copies as $key => $copyName):
            if ($i > 0): ?>
                ...
                <table class="receipt-separator-table" style="width: 100%; margin: 12px 0; border-collapse: collapse; clear: both;">
                    <tr>
                        <td style="width: 16px; font-size: 9px; color: #475569; padding: 0; vertical-align: middle; line-height: 1; text-align: left;">✂</td>
                        <td style="border-bottom: 1.5px dashed #475569; padding: 0; vertical-align: middle; height: 1px; line-height: 1;">&nbsp;</td>
                    </tr>
                </table>
            <?php endif;
            $i++;
                ...
                <table class="header-table">
                    <tr>
                        ...
                        <td class="school-info-col" style="width: 65%; vertical-align: top;">
                            <div style="margin-bottom: 2px; font-size: 8px; font-weight: bold; text-transform: uppercase; color: #64748b; letter-spacing: 0.2px;">
                                <?= h($settings['school_republic'] ?? 'République du Cameroun') ?> &nbsp;|&nbsp; PAIX - TRAVAIL - PATRIE
                            </div>
                            <table style="width: 100%; border-collapse: collapse; border: none;">
                                <tr>
                                    <?php if ($logoBase64): ?>
                                    <td style="width: 36px; vertical-align: top; padding: 0;">
                                        <img src="<?= $logoBase64 ?>" style="max-height: 32px; max-width: 34px; object-fit: contain; float: left; margin-right: 4px;" alt="Logo Établissement">
                                    </td>
                                    <?php endif; ?>
                                    <td style="vertical-align: top; padding-left: 2px; padding-top: 0; padding-bottom: 0;">
                                        <div class="school-name-text" style="font-size: 11px; font-weight: bold; color: #1e3a8a; text-transform: uppercase; margin: 0; line-height: 1.15;">
                                            <?= h($settings['school_name'] ?? 'Collège polyvalent bilingue marie Thérèse') ?>
                                        </div>
                                        <div class="school-slogan-text" style="font-style: italic; font-size: 8.5px; color: #475569; margin: 1px 0;">
                                            <?= h($settings['school_slogan'] ?? 'Discipline - Travail - Succès') ?>
                                        </div>
                                        <div class="school-contact-text" style="font-size: 8.5px; color: #475569; line-height: 1.25;">
                                            Tel: <?= h($settings['school_phone'] ?? '686061923/696007229') ?> &nbsp;|&nbsp; 
                                            Email: <?= h($settings['school_email'] ?? 'fotsomarietherese2024@gmail.com') ?><br>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: right; font-weight: bold; color: #16a34a;"><?= number_format($amountAllocated, 0, '.', ' ') ?></td>
                ...
                <table style="width: 100%; border-collapse: collapse; border: none; margin-bottom: 2px;">
                    <tr>
                        ...
                        <td style="width: 59%; vertical-align: top; padding-right: 4px;">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center; padding: 1px;">
                                                <span style="display: inline-block; padding: 0.5px 2px; border-radius: 3px; font-size: 6.8px; font-weight: bold; color: <?= $statusColor ?>; background-color: <?= $statusBg ?>; text-transform: uppercase;">
                                                    <?= $status ?>
                                                </span>
                                            </td>
                                        </tr>
                            ...
                            <table class="financial-table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td style="font-family: monospace; font-size: 8.8px; padding: 1.5px 2px;"><?= h($hist['reference'] ?: 'N/A') ?></td>
                                            <td style="font-size: 8.8px; padding: 1.5px 2px;"><?= h($hist['payment_method']) ?></td>
                                            <td style="font-size: 8.8px; padding: 1.5px 2px;"><?= date('d/m/Y', strtotime($hist['payment_date'])) ?></td>
                                            <td style="font-size: 8.8px; padding: 1.5px 2px; text-align: right; font-weight: bold;"><?= number_format($hist['amount'], 0, '.', ' ') ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <tr style="background-color: #f8fafc; font-weight: bold;">
                        ...
                        <td style="width: 39%; vertical-align: top; padding-left: 4px;">
                            ...
                            <table style="width: 100%; border-collapse: collapse; border: none; margin-top: 2px;">
                                <tr>
                                    <td style="width: 34px; padding: 0; vertical-align: top;">
