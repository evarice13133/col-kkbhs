                ...
                <div class="row g-3 g-md-4 mb-4 mb-md-5">
                    ...
                    <div class="col-md-8">
                        ...
                        <select name="groupe" class="form-select premium-input">
                            <option value="Groupe 1" <?= ($groupe ?? '') === 'Groupe 1' ? 'selected' : '' ?>>Groupe 1 - Matières Littéraires</option>
                            <option value="Groupe 2" <?= ($groupe ?? '') === 'Groupe 2' ? 'selected' : '' ?>>Groupe 2 - Matières Scientifiques</option>
                            <option value="Groupe 3" <?= ($groupe ?? '') === 'Groupe 3' ? 'selected' : '' ?>>Groupe 3 - Développement Personnel</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label
            ...
            searchInput.addEventListener('input', function() {
                ...
                classItems.forEach(item => {
                    ...
                    if (label.includes(query)) {
                        ...
                        // Optional: Add a highlight effect or animation
                    } else {
