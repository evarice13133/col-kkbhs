                ...
                <div class="row g-3 g-md-4 mb-4 mb-md-5">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="teaching_type_id" id="teaching_type_id" class="form-select premium-input border-primary border-opacity-25" required>
                            ...
                            <?php foreach ($teachingTypes as $tt): ?>
                                <option value="<?= $tt['id'] ?>" data-code="<?= h($tt['code'] ?? '') ?>" <?= (($subject['teaching_type_id'] ?? null) == $tt['id']) ? 'selected' : '' ?>><?= h($tt['nom']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="vhm" class="form-control premium-input text-center"
                            value="<?= h($subject['vhm'] ?? '') ?>" min="0" step="any" placeholder="Ex: 60">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="vhp" class="form-control premium-input text-center"
                            value="<?= h($subject['vhp'] ?? '') ?>" min="0" step="any" placeholder="Ex: 54">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="th_max" class="form-control premium-input text-center"
                            value="<?= h($subject['th_max'] ?? '') ?>" min="0" step="any" placeholder="Ex: 30">
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <input type="text" name="observations" class="form-control premium-input"
                            value="<?= h($subject['observations'] ?? '') ?>" placeholder="Remarques ou détails...">
                    </div>
                        ...
                        <div class="p-3 bg-primary bg-opacity-10 border border-primary border-opacity-25 rounded-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="code_uv" id="code_uv" class="form-control premium-input" placeholder="Ex: INF301" value="<?= h($subject['code_uv'] ?? '') ?>">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="code_ue" id="code_ue" class="form-control premium-input" placeholder="Ex: UE-INF3" value="<?= h($subject['code_ue'] ?? '') ?>">
                                </div>
                            </div>
                        </div>
                    </div>
