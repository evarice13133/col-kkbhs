...
<head>
    ...
    <script>
        ...
        window.NM_I18N = {
            'lang': <?= json_encode((string) $app_lang) ?>,
            'impact': <?= json_encode([
                'loadingTitle' => __('impact_loading_title'),
                'loadingDescription' => __('impact_loading_description'),
                'cancel' => __('impact_cancel'),
                'analysisErrorTitle' => __('impact_analysis_error_title'),
                'analysisErrorMessage' => __('impact_analysis_error_message'),
                'networkErrorTitle' => __('impact_network_error_title'),
                'serverUnavailable' => __('impact_server_unavailable'),
                'lowRisk' => __('impact_low_risk'),
                'mediumRisk' => __('impact_medium_risk'),
                'highRisk' => __('impact_high_risk'),
                'criticalRisk' => __('impact_critical_risk'),
                'none' => __('impact_none'),
                'target' => __('impact_target'),
                'dependencies' => __('impact_dependencies'),
                'historicalData' => __('impact_historical_data'),
                'invalidReferences' => __('impact_invalid_references'),
                'summaryTitle' => __('impact_summary_title'),
                'noTransferTarget' => __('impact_no_transfer_target'),
                'transferDescription' => __('impact_transfer_description'),
                'noTransferAvailable' => __('impact_no_transfer_available'),
                'explicitConfirmation' => __('impact_explicit_confirmation'),
                'enterName' => __('impact_enter_name'),
                'toAuthorizeDelete' => __('impact_to_authorize_delete'),
                'smartDelete' => __('impact_smart_delete'),
                'directDelete' => __('impact_direct_delete'),
                'transferButton' => __('impact_transfer_button'),
                'archiveButton' => __('impact_archive_button'),
                'safeDeleteButton' => __('impact_safe_delete_button'),
                'directDeleteBlocked' => __('impact_direct_delete_blocked'),
                'directDeleteBlockedMessage' => __('impact_direct_delete_blocked_message'),
                'confirmPermanentDelete' => __('impact_confirm_permanent_delete'),
                'noChangeWithoutValidation' => __('impact_no_change_without_validation'),
                'cancelOperation' => __('impact_cancel_operation'),
                'destinationRequired' => __('impact_destination_required'),
                'selectDestination' => __('impact_select_destination'),
                'wrongConfirmationName' => __('impact_wrong_confirmation_name'),
                'nameMismatch' => __('impact_name_mismatch'),
                'deleteConfirmation' => __('impact_delete_confirmation'),
                'sureDelete' => __('impact_sure_delete'),
                'confirmYes' => __('impact_confirm_yes'),
                'operationSuccess' => __('impact_operation_success'),
                'operationFailure' => __('impact_operation_failure'),
                'processingError' => __('impact_processing_error'),
                'processingFailed' => __('impact_processing_failed'),
                'serverError' => __('impact_server_error'),
                'requestError' => __('impact_request_error'),
                'operationError' => __('impact_operation_error')
