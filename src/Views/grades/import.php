        ...
        <div class="col-lg-8">
            <div class="modern-card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                ...
                <div class="card-body p-4 pt-2">
                    ...
                    <a href="/notes/downloadTemplate?class_id=<?= $class_id ?>&subject_id=0" class="btn btn-outline-primary rounded-3 px-4 fw-bold">
            ...
            <div class="modern-card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4 pt-2">
                    <form action="/notes/upload" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="file" id="grade-import-file" name="import_file" class="form-control mb-3" accept=".xlsx" required>
                        <button type="submit" id="grade-import-submit" class="btn btn-outline-success w-100 fw-bold rounded-3 py-3" disabled>
