...
<body>
    ...
    <main class="login-container">
        ...
        <!-- Section Portail (Right) - Formulaire d'inscription -->
        <section class="login-portal" style="padding: 2rem 3.5rem;">
            <div class="portal-header">
                <span
                    style="color: var(--brand-primary); font-weight: 700; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 0.1em; display: block; margin-bottom: 8px;"><?= $isEn ? 'Teacher Registration' : 'Inscription Enseignant' ?></span>
                <h2><?= $isEn ? 'Create your account' : 'Rejoignez-nous' ?></h2>
                <p><?= $isEn ? 'Fill in your details to get started.' : 'Renseignez vos informations pour créer votre profil.' ?>
                </p>
            </div>
            ...
            <form action="/register-teacher" method="POST" id="registerForm">
                ...
                <button type="submit" class="btn-submit" style="margin-top: 0.5rem;">
                    <span><?= $isEn ? 'Register' : 'Créer mon compte' ?></span>
                    <i class="bi bi-check2-circle"></i>
                </button>
            </form>

            <div style="margin-top: 1.5rem; text-align: center; font-size: 0.9rem;">
                <span style="color: var(--text-secondary);"><?= $isEn ? 'Already have an account?' : 'Vous avez déjà un compte ?' ?></span>
                <a href="/login" style="color: var(--brand-primary); font-weight: 600; text-decoration: none; margin-left: 5px; transition: color 0.2s;" onmouseover="this.style.color='var(--text-main)'" onmouseout="this.style.color='var(--brand-primary)'">
                    <?= $isEn ? 'Log in' : 'Connectez-vous' ?>
                </a>
            </div>
