...
<div class="row g-4">
    <div class="col-lg-8">
        ...
        <div class="modern-card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
            ...
            <div class="card-body p-4 pt-2">
                <p class="small text-secondary text-main-theme mb-3"><?= __('teacher_import_template_hint') ?></p>
                <a href="/teachers/download_template" class="btn btn-outline-primary rounded-3 px-4 fw-bold">
        ...
        <div class="modern-card border-0 shadow-sm rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4 pt-2">
                <form action="/teachers/upload" method="POST" enctype="multipart/form-data" id="teacherImportForm">
                    <input type="hidden" name="csrf_token" value="<?= \App\Core\Session::generateCsrfToken() ?>">
                    <input type="file" id="teacher-import-file" name="import_file" class="form-control mb-3" accept=".xlsx" required>
                    <button type="submit" id="teacher-import-submit" class="btn btn-outline-success w-100 fw-bold rounded-3 py-3" disabled>
    ...
    <div class="col-lg-4">
        <div class="modern-card border-0 shadow-sm p-4 rounded-4">
            <h6 class="fw-bold text-body mb-2 text-main-theme"><?= __('data_integrity') ?></h6>
            <p class="small text-secondary text-main-theme mb-0"><?= __('teacher_import_side_hint') ?></p>
        </div>
    </div>
</div>
